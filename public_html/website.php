...
<head>
    ...
    <title>Website - Eworld Education</title>
    <!-- favicons Icons -->
          ...
          <section class="page-header">
            <div class="container">
                <div class="page-header__content">
                    ...
                    <h2 class="page-header__title">Website</h2>
                ...
                <div class="row gutter-y-50">
                    <div class="col-lg-8 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="become-instructor__content">
                            ...
                            <img src="images/website.jpg" class="img-fluid">
                                <h3 class="become-instructor__title mt-4">Website</h3>
                                <p>If eWorldEducation is providing a dedicated college website, here’s a suggested structure for the content and features. This template focuses on showcasing the college’s strengths, academic offerings, and student services to attract prospective students.
