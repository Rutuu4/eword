...
$.TokenList = function (input, url_or_data, settings) {
    ...
    var input_box = $("<input type=\"text\"  autocomplete=\"off\">")
        ...
        .keypress(function (event) {
            ...
            var ret = (keyCode == 32 || (keyCode >= 48 && keyCode <= 57) || (keyCode >= 65 && keyCode <= 90) || (keyCode >= 97 && keyCode <= 122) || (specialKeys.indexOf(event.keyCode) != -1 && event.charCode != event.keyCode));
            return ret;
