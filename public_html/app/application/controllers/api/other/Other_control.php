...
TEXT;
    ...
    public function city_project_get()
    {
        $data = $this->get();
        ...
        $params = array(
            ...
            'orderby'       => 'city_project.name ASC', // Assuming 'city_name' is the column for city names
        );
    ...
    public function city_job_get()
    {
        ...
        $params = array(
            ...
            'orderby'       => 'city_job.name ASC', // Assuming 'city_name' is the column for city names
        );
