...
class Website_control extends REST_Controller {
    ...
    public function website_list_post()
    {
        ...
        {           
                ...
                $wherestring    = "id=4";
                $params = array(
                        'table'         => TBL_WEBSITE_LIST.' as website_list',
                ...
                $wherestring    = "website_list.status=1  order by website_list.display_order ASC";
                $params = array(
                'table'         => TBL_WEBSITE_LIST.' as website_list',
                'wherestring'   => !empty($wherestring)?$wherestring:'',
