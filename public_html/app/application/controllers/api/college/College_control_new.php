            ...
            $per_page   = $page * PRODUCT_PAGINATION_SIZE;
                ...
                if(!empty($data['course_id']))
                {
                 ...
                 $wherestring    .= " GROUP BY college_university_details.id";
                    ...
                    $fields         = ['college_university_details.*,m_city.name AS city_name','GROUP_CONCAT(DISTINCT courses_details.name ORDER BY RAND() SEPARATOR ", ") as courese_list_name'];
                ...
                'join_tables'   => array(
                                    ...
                                    TBL_COURSES_DETAILS.' as courses_details'  => "FIND_IN_SET(LOWER(TRIM(courses_details.name)), LOWER(TRIM(college_university_details.course_name_list))) > 0",
