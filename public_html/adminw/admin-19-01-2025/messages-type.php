        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
               Manage Message Type
                  <a href="master/create-message-type.php" class="btn btn-primary pull-right" >Create Message Type</a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM m_message_type order by id desc";
                ...
                <tr>
                  ...
                  <td>
                    <a href="master/edit-message-type.php?id=<?php echo $row['id'];?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
