        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
               Manage Year List
                  <a href="master/create-year.php" class="btn btn-primary pull-right" >Create Year List</a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM m_year order by id desc";
                ...
                <tr>
                  ...
                  <td>
                    <a href="master/edit-year.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
