...
$qury1="UPDATE scholarship_loan_details SET name='$name',short_details='$short_details',details='$details',pdf_file='$pdf_file',website_links='$website_links',status='$status'  where id='$id'";
