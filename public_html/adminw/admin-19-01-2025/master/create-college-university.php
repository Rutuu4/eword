...
{  
  ...
  $qury1="INSERT INTO college_university_details(user_id, create_datetime, college_university_type_id, name, city_id, website_link, course_ids, status) VALUES ('$login_id','$create_datetime','$college_university_type_id','$name','$city_id','$website_link','$course_ids','$status')";          
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="course_ids[]" id="course_ids[]"  multiple="multiple" class="form-control select2"  data-placeholder="Select Course" >
                                  ...
                                  <?php 
                                    ...
                                    {
                                    ?>
                                     <option value="<?=$row_fv['id'];?>" > <?=$row_fv['name'];?> </option>
