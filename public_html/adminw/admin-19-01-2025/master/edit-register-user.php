...
$interesting_exrta_course_id=mysqli_real_escape_string($conn,$_POST['interesting_exrta_course_id']);
  ...
  $qury1="Update registration set username='$username', password='$password',fullname='$fullname',email='$email',city='$city',status='$status',interesting_main_course_id='$interesting_main_course_id',course_details_ids='$course_details_ids',interesting_city_ids='$interesting_city_ids',is_chat_block='$is_chat_block',interesting_exrta_course_id='$interesting_exrta_course_id' where id='$id'";          
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="interesting_main_course_id"  id="main_courses_id"  class="form-control" >
...
{ ?>
   ...
   <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="interesting_exrta_course_id"  id="extra_course_id"  class="form-control"  required>
    ...
    <div class="col-sm-8 row">
        ...
        while ($row_fv = $result_fv->fetch_assoc()) {
            ...
            <div class="col-sm-4">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="course_details_ids[]" <?= $isChecked; ?> value="<?= htmlspecialchars($row_fv['id']); ?>"> <?= htmlspecialchars($row_fv['name']); ?>
                    </label>
                </div>
            </div>
        <?php } ?>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="interesting_city_ids[]" id="interesting_city_ids[]"  multiple="multiple" class="form-control select2"  data-placeholder="Select Interesting City" >
