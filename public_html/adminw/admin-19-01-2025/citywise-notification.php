        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            -->
                    <div class="box-body">
              <h4>
              Manage Citywise Notification List (Last 30 Days)
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $qry="SELECT mobile_notification.*,m_main_courses.name AS main_course_name, GROUP_CONCAT(m_city.name ORDER BY m_city.id) AS city_name_list FROM mobile_notification 
