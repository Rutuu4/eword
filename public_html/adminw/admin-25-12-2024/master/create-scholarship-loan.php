...
$website_links=mysqli_real_escape_string($conn,$_POST['website_links']);
  ...
  $qury1="INSERT INTO scholarship_loan_details(user_id, create_datetime, name, short_details, details, pdf_file, website_links, status) VALUES ('$login_id','$create_datetime','$name','$short_details','$details','$pdf_file','$website_links','$status')";          
