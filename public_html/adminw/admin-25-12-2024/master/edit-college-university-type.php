...
{  
  ...
  $qury1="Update m_college_university_type set name='$name',video_link='$video_link', status='$status'  where id='$id'";          
  $sq1=$conn->query($qury1);

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-college-university-type.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM m_college_university_type WHERE id='$id'";  
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Update College University Type</h1>
    </section>
