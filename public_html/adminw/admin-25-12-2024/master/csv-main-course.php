...
if($_POST['h1']==1)
{
              ...
              { 
                      ...
                      if(!empty($name))
                      {
                                  ...
                                  while($i<$total_array-1)
                                  {
                                        ...
                                        $qry_chk="SELECT id FROM m_main_courses where name='$name'";
                                        ...
                                        {
                                           $insert_array[] ="('$login_id','$create_datetime','$name','$video_link','1')";
                                        }
      ...
      if(!empty($insert_array))
      {
         ...
         $qury2="INSERT INTO m_main_courses(user_id, create_datetime, name, video_link, status)
...
if(empty($error_msg))
{
  header("location:../manage-main-course.php");
}
                  ...
                  <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> CREATE MAIN COURSE WITH CSV </h3>
                     ...
                     <div class="box-body">
                      ...
                      <div class="col-sm-2">
                        ...
                        <div class="col-sm-1">
                          <a href="../../download-main-course.csv" download="download-main-course.csv" class="btn btn-success" download role="button">Dwonload Demo File</a>
                        </div>
                    </div>
