          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT college_university_details.*,m_city.name AS city_name,m_college_university_type.name AS college_university_type_name FROM college_university_details 
                  left join m_city on m_city.id=college_university_details.city_id
                   left join m_college_university_type on m_college_university_type.id=college_university_details.college_university_type_id
                  order by college_university_details.id DESC";
                ...
                <tr>
                  ...
                  <td>
                    <a href="master/edit-college-university.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
