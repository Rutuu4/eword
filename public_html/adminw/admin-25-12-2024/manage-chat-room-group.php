          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT chat_room_group.*,chat_course.name AS chat_course_name,count(registration.id) AS group_member_count FROM chat_room_group 
                  ...
                  group by chat_room_group.id order by chat_course.id desc";
