          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM banner order by id ASC";
                ...
                <tr>
                  ...
                  <td><?=$row['name'];?></td>
                  <td><?=$row['link'];?></td>
                  <td><?php if(!$row['img']==""){?><img src="../../<?=$row['img'];?>" style="width:100px; height:60px;"/><?php } ?>
                        </td>
                  <td><?=$statuss;?></td>
                                
                  <td>
                    <a href="master/edit-banner.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
