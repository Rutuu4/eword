...
{  
  ...
  $qry_chk="SELECT main_courses_id,name from courses_details where id=$courses_details_id";
...
if($pdf_file==$idir."."){ $pdf_file=""; }
  ...
  $qury1="INSERT INTO admission_process(user_id, create_datetime, main_courses_id, courses_details_id, name, video_link, details, pdf_file, status,website_list) VALUES ('$login_id','$create_datetime','$main_courses_id','$courses_details_id','$name','$video_link','$details','$pdf_file','$status','$website_list')";          
             ...
             <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="courses_details_id"  id="courses_details_id"  class="form-control select2"  required>
                            ...
                            <?php 
                            $sqlb="SELECT id,name FROM courses_details where status=1";
 ...
 -->
            ...
            <div class="input_img_fields_wrap">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="website_link[]"  id="website_link" placeholder="Enter Website Link "  required>
                </div>
            </div>
          </div>
