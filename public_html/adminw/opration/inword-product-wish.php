      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
               Product-Wise Inword List (Last 30 Days)
              </h4>
              <?php
              ...
              <div class="form-group">
               ...
               <div class="col-lg-2" style="padding-top:24px">
                    ...
                    <a style="margin-left: 10px" href="inword-product-wish-csv.php?fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>&&product_id=<?php echo $product_id; ?>" class="btn btn-primary" role="button">Export CSV</a> 
                  </div>
                <!-- /.input group -->
               </div>
              </form>
          ...
          if(!empty($row['created_date'])){ $date=date("d-m-Y", strtotime($row['created_date'])); } else{ $date='';}
                ...
                <tr>
                  ...
                  <td><?=$row['quantity'];?></td>
                   <td>
                    <a href="master/view-inword-order.php?key=<?=base64_encode($row['inword_id'])?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                  </td>
                </tr>
                <?php }  } ?>
              </table>
