      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
                Receive Order List (Last 30 Days)
              </h4>
              <?php
              ...
              <div class="form-group">
               ...
               <div class="col-lg-2" style="padding-top:24px">
                    <button name="search_process" class="btn btn-primary pull-left"><i class="fa fa-search"></i>Search</button>
                      <a style="margin-left: 10px" href="order-csv-report.php?status=<?php echo '3'; ?>&&fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>" class="btn btn-primary" role="button">Export CSV</a>
                  </div>
                <!-- /.input group -->
               </div>
              </form>
          ...
          ON product_order.user_id = register1.id where product_order.status=3";
          ...
          $result=$conn->query($qry);
                  ...
                  while($row = $result->fetch_array()){
                      $status = "<span class='badge bg-gray'>Receive</span>";
