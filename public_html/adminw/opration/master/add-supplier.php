<?php 
  ...
  if(isset($_POST['save']))
  {
    ...
    $query="INSERT INTO m_supplier(name, mobile, alternative_phone, email,address, gstno, city, state, status, input_date) VALUES ('$name','$mobile','$alternative_phone','$email','$address','$gstno','$city','$state','$status','$input_date')";
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="name" placeholder="Name of Supplier" required>
              </div>
            </div>
             <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="gstno" placeholder="GSTIN No" required>
              </div>
            </div>
            <div class="form-group">
