...
$max_id_qry="SELECT * FROM po ORDER BY id DESC";
...
if(isset($_POST['submit1'])  && count($_POST['pname'])>=1)
{
  ...
  $acceptation_no = mysqli_real_escape_string($conn,$_POST['invoice_no']);
  ...
  {   
    ...
    $unit=$row_productunit['product_unit'];
     ...
     $qury1="INSERT INTO po(po_number, supplier_id, request_date, po_date, invoice_no, invoice_date, acceptation_no, acceptation_date, status, created_date,user_id) VALUES ('$po_number','$supplier_id','$request_date','$po_date','$invoice_no','$invoice_date','$acceptation_no','$acceptation_date','$status','$created_date','$login_id')";
        $sq1=$conn->query($qury1);
        $last_order_id =mysqli_insert_id($conn); 

      foreach($insert_product_array as &$value) {   $value=str_replace('po_id', $last_order_id, $value);   }
        ...
        { 
         ...
         $qury3="INSERT INTO txn_history_report(txn_type, txn_id, uid, txn_date) VALUES ('3','$last_order_id','$login_id','$txn_date')";
        ...
        <div class="box-header with-border">
          <h3 class="box-title">CREATE PO</h3>
            ...
            <div class="box-body">
             ...
             <input type="hidden" id="define_advanced_order_prod  uct_additional_parameter_shopcart_filter_activation"  class="form-control"  value="<?=$define_advanced_order_product_additional_parameter_shopcart_filter_activation;?>"/>
 ...
 <div class="col-md-6">
            ...
            <div class="form-group" style="margin-bottom: 35px">
                     ...
                     <div class="form-group" style="margin-bottom: 35px">
                      ...
                      <div class="col-sm-8">
                      <input type="text" class="form-control" name="acceptation_no" required>
                      </div>
                    </div>
                     <div class="clearfix"></div>
            ...
            <div class="col-md-6">
              <div class="form-group" style="margin-bottom: 35px">
                    ...
                    <div class="clearfix"></div>
                     ...
                     <div class="col-sm-8">
                     <input type="text" class="form-control pull-right datepicker" name="acceptation_date" value="<?php echo date('d-m-Y'); ?>" required>
                      </div>
                    </div>
                    </div> 
                     <div class="clearfix"></div>
