...
$max_id_qry="SELECT * FROM product_order ORDER BY id DESC";
  ...
  {  
    ...
    $unit=$row_productunit['product_unit'];
      ...
      if($product_id>0)
      {
          ...
          $insert_product_array[] ="(NULL,'orderr_id','$product_id','$quantity','$unit','$status','$created_date')";
      ...
      $qry_productorder="INSERT INTO product_order(invoice_id, invoice_date, user_id, unit, remark, created_date, status,customer_id) VALUES ('$invoice_id','$invoice_date','$login_id','$unit','$remark','$created_date','$status','$customer_id')";
        $sq1=$conn->query($qry_productorder);
        $last_order_id =mysqli_insert_id($conn); 

      foreach($insert_product_array as &$value) {   $value=str_replace('orderr_id', $last_order_id, $value);   }
        ...
        $qury2="insert into product_order_trans(id, order_id, product_id, quantity, unit, status, created_date) 
         ...
         $qury3="INSERT INTO txn_history_report(txn_type, txn_id, uid, txn_date) VALUES ('2','$last_order_id','$login_id','$created_date')";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">CREATE OUTWORD</h3>
        </div>
          ...
          <table id="example1" class="table table-bordered table-striped" style="margin-bottom:28px;">
            ...
            <div class="form-group" style="margin-bottom: 35px">
                     ...
                     <div class="form-group">
                      <label for="passwrod" class="col-sm-4">Select-Customer :</label>
                       <div class="col-sm-8">
                        <select class="form-control" name="customer_id" required>
                          <option value="">Select-Customer</option>
                          <?php
                            $qrys = $conn->query("SELECT * FROM m_customer WHERE status = 1");
            ...
            <div class="col-md-6">
              <div class="form-group" style="margin-bottom: 35px">
                      ...
                      <div class="col-sm-8">
                       <input type="text" class="form-control pull-right datepicker" name="request_date" value="<?php echo date('d-m-Y'); ?>" disabled>
                      </div>
                    </div>
                     <div class="clearfix"></div>
                       <div class="form-group"  style="margin-bottom: 35px">
