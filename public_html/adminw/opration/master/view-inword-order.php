...
$qry="SELECT inword.*,user.name,m_supplier.name AS supplier_name,m_supplier.mobile,m_supplier.email,m_supplier.city,m_state.name AS State_name from  inword 
    ...
    <section class="col-lg-12 connectedSortable">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Inword Order-Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php
  ...
  $qry1="SELECT inword_product.*, product.product_name as product_name,product_category.name AS category_name from inword_product 
