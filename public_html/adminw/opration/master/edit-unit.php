...
<?php 
  ...
  if(empty($_GET['key'])){
    ...
    $getdata = $conn->query("SELECT * FROM `m_unit` WHERE id = $getid")->fetch_object();
  }
  ...
  if(isset($_POST['save'])){
    ...
    $updateqry = "UPDATE `m_unit` SET `name`='$name',`status`='$status' WHERE id = $getid";
        ...
        <div class="box-body">
          <form action="" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2">Unit Name</label>
              <div class="col-sm-10">
