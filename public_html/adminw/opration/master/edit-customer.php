<?php 
  ...
  if(empty($_GET['key'])){
    ...
    $qry_data="SELECT * FROM m_customer WHERE id='$getid'";
  ...
  if(isset($_POST['save']))
  {
   ...
   $query="UPDATE m_customer SET name='$name',mobile='$mobile',alternative_phone='$alternative_phone',email='$email',address='$address',gstno='$gstno',city='$city',state='$state',status='$status' WHERE id='$id'";
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="name" placeholder="Name of Customer" value="<?php echo $row_data['name']; ?>" required>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="gstno" placeholder="GSTIN No" value="<?php echo $row_data['gstno']; ?>" >
              </div>
            </div>
            <div class="form-group">
