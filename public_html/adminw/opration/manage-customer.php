          ...
          <div class="box">
            ...
            <div class="box-body">
              <h4>
                ...
                <a href="master/add-customer.php" class="btn btn-link pull-right" style="color: blue;">Want to Add customer ?</a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $qry="SELECT m_customer.*, m_state.name AS state_name from m_customer  
                left join m_state on m_customer.state=m_state.id
                order by m_customer.input_date desc";
                ...
                <tr>
                  ...
                  <td ><?=$status?></td>
                  <td>
                    <a href="master/edit-customer.php?key=<?=base64_encode($row[0])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
