      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
                Find All Your City Here
                <a href="master/add-city.php" class="btn btn-link pull-right" style="color: blue;">Want to Add City ?</a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $getcityqry = $conn->query("SELECT * FROM `m_city`");
                  $i = 1;
                ...
                <tr>
                  ...
                  <td style="width: 30%">
                    <a href="master/edit-city.php?key=<?=base64_encode($rowcity[0])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
