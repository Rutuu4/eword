        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            -->
                    <div class="box-body">
              <h4>
              Manage Notification List (Last 30 Days)
               <a href="master/create-notification.php" class="btn btn-primary pull-right" >Create Notification</a>
              </h4>
              <?php
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $qry="SELECT * FROM mobile_notification WHERE mobile_notification.id>0";
                  ...
                  $qry .= " order by mobile_notification.id desc";
