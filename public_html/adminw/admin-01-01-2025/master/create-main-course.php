...
{  
  ...
  $qury1="INSERT INTO m_main_courses(user_id, create_datetime, name, video_link, status,isExtra) VALUES ('$login_id','$create_datetime','$name','$video_link','$status','$isExtra')";          
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <div class="col-sm-3 col-xs-6">
                          <label>
                          <input name="isExtra" type="radio" value="0" checked="checked"  />
                          No </label>
                        </div>
                        <div class="col-sm-3 col-xs-6">
                          <label>
                          <input name="isExtra" type="radio" value="1"  />
                          Yes</label>
                        </div>
