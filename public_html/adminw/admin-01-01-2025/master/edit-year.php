...
{  
  ...
  $qury1="Update m_year set name='$name', status='$status'  where id='$id'";          
  $sq1=$conn->query($qury1);

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-year.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM m_year WHERE id='$id'";  
