...
{  
  ...
  $qury1="Update subscription_package set price='$price'  where id='$id'";          
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="number" class="form-control" name="price"  id="name" placeholder="Enter Amount " value="<?=$row['price'];?>"  required>
              </div>
            </div>
