...
$interesting_city_ids=implode(",",$_POST['interesting_city_ids']);
  ...
  $qury1="Update registration set username='$username', password='$password',fullname='$fullname',email='$email',city='$city',status='$status',interesting_main_course_id='$interesting_main_course_id',course_details_ids='$course_details_ids',interesting_city_ids='$interesting_city_ids' where id='$id'";          
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="interesting_main_course_id"  id="main_courses_id"  class="form-control select2"  required>
