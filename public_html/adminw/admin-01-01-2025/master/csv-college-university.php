...
if (!empty($course_list)) {
    ...
    $course_ids = !empty($matching_ids1) ? implode(",", $matching_ids1) : '';
} else 
{
    $course_ids = '';
}
                                                  ...
                                                  $insert_array[] ="('$login_id','$create_datetime','$college_university_type_id','$name','$city_id','$website_link','1','$course_ids')";
                                              }
                                              else
                                              {
      ...
      if(!empty($insert_array))
      {
         ...
         $qury2="INSERT INTO college_university_details(user_id, create_datetime, college_university_type_id,name, city_id,website_link, status,course_ids)
