...
{  
  ...
  $qury1="INSERT INTO chat_room_group(chat_course_id, name, status, member_limit, is_hide) VALUES ('$chat_course_id','$name','$status','$member_limit','$is_hide')";
  
  // echo $qury1;         
  $sq1 = $conn->query($qury1);  
  $last_idd=mysqli_insert_id($conn);
  if(!$last_idd==""){ header("location:../manage-chat-room-group.php"); }
