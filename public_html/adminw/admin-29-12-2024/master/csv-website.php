...
if($_POST['h1']==1)
{
              ...
              { 
                      ...
                      if(!empty($name))
                      {
                                  ...
                                  while($i<$total_array-1)
                                  {
                                        ...
                                        $qry_chk="SELECT id FROM website_list where name='$name'";
                                        ...
                                        {
                                           $insert_array[] ="('$name','$website_link','1')";
                                        }
      ...
      if(!empty($insert_array))
      {
         ...
         $qury2="INSERT INTO website_list(name, website_link, status)
            ...
            <div class="box-content">
              <div class="box box-info col-md-6">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> CREATE WEBSITE WITH CSV </h3>
                </div>
                     <div class="box-body">
                      ...
                      <div class="col-sm-2">
                        ...
                        <div class="col-sm-1">
                          <a href="../../download-website.csv" download="download-website.csv" class="btn btn-success" download role="button">Dwonload Demo File</a>
                        </div>
                    </div>
