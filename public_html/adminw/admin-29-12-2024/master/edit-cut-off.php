...
echo $qury1="UPDATE cut_off_details SET year_id='$year_id',name='$name',short_details='$short_details',details='$details',pdf_file='$pdf_file',status='$status'  where id='$id'";
