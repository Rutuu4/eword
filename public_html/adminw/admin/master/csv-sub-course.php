...
if($_POST['h1']==1)
{
              ...
              { 
                      ...
                      if(!empty($name))
                      {
                                  ...
                                  while($i<$total_array-1)
                                  {
                                        ...
                                        $qry_chk="SELECT id FROM m_exrta_course where name='$name' and main_courses_id='$main_courses_id'";
                                        ...
                                        else
                                        {
                                              ...
                                              $qury2="INSERT INTO m_exrta_course(main_courses_id,user_id, create_datetime, name, status)
                                                values ('$main_courses_id','$login_id','$create_datetime','$name','1')";
                                              $sq2=$conn->query($qury2);
                                              $last_idd=mysqli_insert_id($conn);

                                              $insert_course_array[] ="('$login_id','$create_datetime','$main_courses_id','$name','1','$last_idd')";
                                        }
      ...
      if(!empty($insert_course_array))
      {

        $qry_insert = "INSERT INTO courses_details (user_id, create_datetime, main_courses_id, name, status, extra_course_id)  values".implode(',',$insert_course_array)."";
            ...
            <div class="box-content">
              <div class="box box-info col-md-6">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> CREATE SUB COURSE WITH CSV </h3>
                </div>
                     <div class="box-body">
                    ...
                    <select class="form-control" name="main_courses_id"  id="main_courses_id" required="">
                          ...
                          <?php
                            $qrys = $conn->query("SELECT id,name FROM m_main_courses WHERE status = 1 and isExtra=1 order by display_order");
