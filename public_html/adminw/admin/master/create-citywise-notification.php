...
$qury1="INSERT INTO mobile_notification(title, mesage,datee, img,details,status,website_link,notification_type,city_ids) VALUES ('$title','$mesage','$datee','$img','$details','$status','$website_link','$notification_type','$city_ids')";
...
$set_title='E World Notification';
            ...
            if (!empty($city_ids)) 
            {
                $course_ids_array = explode(',', $city_ids);
                foreach ($course_ids_array as $city_id) {
                    $conditions[] = "FIND_IN_SET('$city_id', registration.interesting_city_ids) > 0";
                }
            }
...
if(!$last_idd=="")
{ 
  header("location:../citywise-notification.php"); 
}
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Create Citywise Notification</h1>
    </section>
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateCheckboxes()">
            ...
            <div align="center" style="font-weight:bold;color:red">
                  <?php if($chk==1){ echo "City Selection Compulsory";} ?>
              </div>
    ...
    <div class="col-sm-8 row">
        ...
        ?>
            <div class="col-sm-3">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="city_ids[]" value="<?=$row_fv['id'];?>"> <?=$row_fv['name'];?>
                    </label>
                </div>
            </div>
        <?php } ?>
...
$(document).ready(function () {
  ...
  function validateCheckboxes() {
    const checkboxes = document.querySelectorAll('input[name="city_ids[]"]');
    let isChecked = false;
    ...
    if (!isChecked) {
      alert("City Selection Compulsory");
      return false;
    }
