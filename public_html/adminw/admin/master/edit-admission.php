...
$qury1="UPDATE admission_process SET main_courses_id='$main_courses_id',courses_details_id='$courses_details_id',name='$name',video_link='$video_link',details='$details',pdf_file='$pdf_file',status='$status',website_list='$website_list',exrta_cours_name='$exrta_cours_name' where id='$id'";
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="courses_details_id"  id="courses_details_id"  class="form-control select2"  required>
                            ...
                            <?php 
                            $sqlb="SELECT id,name FROM m_exrta_course where status=1 and is_hide=0 GROUP BY TRIM(LOWER(name))";
                            $resultb = $conn->query($sqlb);
                            while($rowb = $resultb->fetch_array())
                            {
                              ?>
                              <option <?php if(trim(strtolower($row['name'])) == trim(strtolower($rowb['name']))) { echo "selected"; } ?> value="<?=$rowb['id'];?>"> <?=$rowb['name'];?> </option>
                              <?php } ?>
                                  </select>
                      </div>
                    </div>  
             ...
             <?php if(!$qm1==""){?>   
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                       ...
                       <div class="col-sm-1">
                       <a button class="btn btn-danger btn-sm" onClick="window.open('master/delete-admission-process-pdf.php?id=<?=$id;?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i class="fa fa-times"></i></button></a>
                     </div>
                </div>
                 <?php  } ?>
...
<!-- <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="number" class="form-control" name="display_order"  id="display_order" placeholder="Enter Display Order " value="<?=$row['display_order'];?>"  >
              </div>
            </div>-->
