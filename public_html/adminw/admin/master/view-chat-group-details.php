...
<?php
  ...
  else
  {
          ...
          $qry1="SELECT chat_room_group.*,chat_course.name AS chat_course_name FROM chat_room_group 
                  left join chat_course on chat_course.id=chat_room_group.chat_course_id
                
          WHERE chat_room_group.id='$getid' group by chat_room_group.id";
...
?>                                          
                                         ...
                                         <th><?=$statuss;?></th>
                                         <!--<td>
                                           <a target="_blank" href="master/edit-register-user.php?id=<?php echo $row_purchase_tnx['id'];?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                         </td>-->
                                         <td><a href="master/edit-register-user.php?key=<?=base64_encode($row_purchase_tnx['id'])?>" class="btn btn-warning"><i class="fa fa-eye"></i></a></td>
