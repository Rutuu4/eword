...
<body>
              ...
              <table width="280" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="280" height="41">
                    <div align="center" class="text-blue">Are You sure , You want to Delete .? </div>
                  </td>
                </tr>
                <tr>
                  <td>
  ...
  if ($a == 1) {
    ...
    if ($_GET['id'] != "") {
      ...
      $qury1 = "Delete From college_university_details where id='$id'";
      $sq1 = $conn->query($qury1);


      if ($sq1 == true) {
        echo ("<script language=\"javascript\">");
        echo ("window.opener.location.href = 'manage-college-university.php?page=" . $currentPage . "';");
        echo ("window.close()");
        echo ("</script>");
      } else {
