...
$qury1="UPDATE f_courses SET name='$name',status='$status' where id='$id'";

 $sq1 = $conn->query($qury1); 

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-foreign-education-course.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM f_courses WHERE id='$id'";  
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Foreign Education Course Details</h1>
            </section>
