...
$college_university_name=mysqli_real_escape_string($conn,$_POST['college_university_name']);
$study_city_id=mysqli_real_escape_string($conn,$_POST['study_city_id']);
if($study_city_id>0)
{

    $qry = "SELECT name FROM m_city where id='$study_city_id'";
    $result = $conn->query($qry);
    $row = $result->fetch_array();
    $study_city=$row['name'];
...
$is_chat_block=mysqli_real_escape_string($conn,$_POST['is_chat_block']);
$interesting_exrta_course_id=mysqli_real_escape_string($conn,$_POST['interesting_exrta_course_id']);

$qury1="Update registration set status='$status',is_chat_block='$is_chat_block' where id='$id'";          
          ...
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
               <label class="control-label col-sm-2">Username:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="username"  id="username"  value="<?=$row['username'];?>"  placeholder="Enter Username as Email"  readonly>
                  </div>
           </div>
           ...
           <div class="form-group">
               <label class="control-label col-sm-2">Name:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="fullname"  value="<?=$row['fullname'];?>"  id="first_name" placeholder="Enter Fullname"  readonly>
                  </div>
           </div>
           ...
           <div class="form-group">
               <label class="control-label col-sm-2">Email:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="email"   value="<?=$row['email'];?>"   id="email" placeholder="Enter Email" readonly>
                  </div>
           </div>
            ...
            <div class="form-group">
               <label class="control-label col-sm-2">Residence City/District:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="city"   value="<?=$row['city'];?>"   id="city" placeholder="Enter Residence City/District" readonly>
                  </div>
           </div>
            <div class="form-group">
               <label class="control-label col-sm-2">Current Study:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="current_study"   value="<?=$row['current_study'];?>"   id="city" placeholder="Enter Current Study" readonly>
                  </div>
           </div>
           <div class="form-group">
               <label class="control-label col-sm-2">College/University Name:</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" name="college_university_name"   value="<?=$row['college_university_name'];?>"   id="city" placeholder="Enter College/University Name" readonly>
                  </div>
           </div>
           ...
           <div class="form-group">
                      ...
                      <div class="col-sm-8">
                           ...
                           <select name="study_city_id"  id="study_city_id"  class="form-control" readonly>
