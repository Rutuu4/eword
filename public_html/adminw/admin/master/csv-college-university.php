              ...
              { 
                      ...
                      if(!empty($name))
                      {
                                  ...
                                  while($i<$total_array-1)
                                  {
                                        ...
                                        $qry_chk="SELECT id FROM college_university_details where name='$name' and college_university_type_id=$college_university_type_id $addquery  ";
                                        ...
                                        if($rowcount>0)
                                        {
                                             ...
                                             /* $error_msg[]='This College Name Exists';
                                              $error_sku[]=$data[0].'-'.$data[2];*/
                                        ...
                                        else
                                        {
                                              ...
                                              if($rowcount_city>0)
                                              {
                                                ...
                                                $qury2="INSERT INTO college_university_details(user_id, create_datetime, college_university_type_id,name, city_id,website_link, status)
                                                             VALUES ('$login_id','$create_datetime','$college_university_type_id','$name','$city_id','$website_link',1)";
