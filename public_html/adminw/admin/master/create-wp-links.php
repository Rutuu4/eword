...
if ($_POST['h1'] == 1) {
    ...
    $qury1 = "INSERT INTO joining_links (group_name, description, whatsapp_joining_link, city_id) 
          VALUES ('$name', '$description', '$whatsapp_joining_link', '$city_id')";

    // echo $qury1; // only for debugging
                        ...
                        <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea class="form-control" placeholder="Description" style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="description" id="description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="whatsapp_joining_link" id="whatsapp_joining_link" placeholder="Enter Whatsapp Joining Link" required>
