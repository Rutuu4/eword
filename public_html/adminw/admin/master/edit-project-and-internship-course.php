...
$qury1="UPDATE p_courses SET name='$name',status='$status' where id='$id'";

 $sq1 = $conn->query($qury1); 

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-project-and-internship-course.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM p_courses WHERE id='$id'";  
