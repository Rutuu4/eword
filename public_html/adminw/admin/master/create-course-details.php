...
if($pdf_file==$idir."."){ $pdf_file=""; }
  ...
  $qury1="INSERT INTO courses_details(user_id, create_datetime, main_courses_id, extra_course_id, name, video_link, details, pdf_file, status) VALUES ('$login_id','$create_datetime','$main_courses_id','$extra_course_id','$name','$video_link','$details','$pdf_file','$status')";          
