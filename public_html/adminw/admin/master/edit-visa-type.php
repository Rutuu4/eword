...
if ($_POST['h1'] == 1) {
    ...
    $qury1 = "UPDATE visa_type SET name='$name',status='$status' where id='$id'";

    $sq1 = $conn->query($qury1);

    if (mysqli_affected_rows($conn) >= 1) {
        header("location:../manage-visa-type.php");
    }
}
...
<body class="<?= $bodyclass ?>">
    ...
    if (!empty($_GET['key'])) {
        ...
        $qry = "SELECT * FROM visa_type WHERE id='$id'";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Visa Type Details</h1>
            </section>
