...
if ($_POST['h101'] == 1) {
    if ($_GET['id'] != "") {
        ...
        try {
            // Delete related records from foreign_education_countries
            $conn->query("DELETE FROM foreign_education_countries WHERE foreign_education_id = '$id'");
            
            // Delete related records from foreign_education_visa_types
            $conn->query("DELETE FROM foreign_education_visa_types WHERE foreign_education_id = '$id'");
            
            // Delete related records from foreign_education_exam_types
            $conn->query("DELETE FROM foreign_education_exam_types WHERE foreign_education_id = '$id'");

            // Now delete the record from the foreign_education table
            $conn->query("DELETE FROM foreign_education WHERE id = '$id'");
