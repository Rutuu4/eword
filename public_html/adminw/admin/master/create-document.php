...
{  
  ...
  $qry_chk="SELECT MAX(id) AS max_id  FROM documents_details";    
  $result_chk=$conn->query($qry_chk);
  $row_chk=$result_chk->fetch_array();
  $display_order=$row_chk['max_id']+1;

  $qury1="INSERT INTO documents_details(user_id, create_datetime, name, details, link, status,display_order) VALUES ('$login_id','$create_datetime','$name','$details','$link','$status','$display_order')";          
          ...
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <textarea class="form-control" placeholder="Description" style="width: 100%; height: 70px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="details" id="details" ></textarea>
