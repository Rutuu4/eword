...
{  
  ...
  $qury1="INSERT INTO college_university_details(user_id, create_datetime, college_university_type_id, name, city_id, website_link, course_ids, status,course_name_list) VALUES ('$login_id','$create_datetime','$college_university_type_id','$name','$city_id','$website_link','$course_ids','$status','$course_name_list')";          
