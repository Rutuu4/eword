...
$qury1="INSERT INTO mobile_notification(title, mesage,datee, img,details,status,website_link) VALUES ('$title','$mesage','$datee','$img','$details','$status','$website_link')";
...
$message =mysqli_real_escape_string($conn,$_POST['mesage']);
$imageUrl = '';  


sendNotificationandroid($accessToken, $deviceTokens, $title, $message, $imageUrl, $last_idd);
