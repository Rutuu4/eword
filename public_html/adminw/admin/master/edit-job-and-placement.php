...
if ($_POST['h1'] == 1) {
    ...
    $conn->query("DELETE FROM job_placements_openings WHERE job_placement_id = '$id'");
    foreach ($courses_ids as $courses_id) {
        $courses_id = mysqli_real_escape_string($conn, $courses_id);
        $conn->query("INSERT INTO job_placements_openings(job_placement_id, opening_id) VALUES('$id', '$courses_id')");
    }
...
<body class="<?= $bodyclass ?>">
    ...
    if (!empty($_GET['key'])) {
        ...
        $qry = "SELECT * FROM job_placements WHERE id='$id'";
        ...
        $selected_course_ids = [];
        $res = $conn->query("SELECT opening_id FROM job_placements_openings WHERE job_placement_id = '$id'");
        while ($r = $res->fetch_assoc()) {
            $selected_course_ids[] = $r['opening_id'];
        }
    }
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Job and Placement</h1>
            </section>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="name" id="name"
                                        placeholder="Enter Name " value="<?= $row['company_name']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="website_link" id="website_link"
                                        placeholder="Enter Institute Link" value="<?= $row['company_website']; ?>">
                                </div>
                            </div>
