...
if ($_POST['h1'] == 1) {
    ...
    if ($result) {
        ...
        if (!empty($_POST['courses_id']) && is_array($_POST['courses_id'])) {
            ...
            if (!empty($values)) {
                $sql_countries = "INSERT INTO tuition_and_training_courses (tuition_and_training_id, course_id) VALUES " . implode(',', $values);
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Add Tuition and Training</h1>
            </section>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="city_id" id="city_id" class="form-control" required>
                                        ...
                                        <?php
                                        $sqlb = "SELECT id,name FROM city_tuition where status=1 ORDER BY name ASC";
                                        $resultb = $conn->query($sqlb);
                                        while ($rowb = $resultb->fetch_array()) {
                                        ?>
                                            <option value="<?= $rowb['id']; ?>"> <?= $rowb['name']; ?> </option>
