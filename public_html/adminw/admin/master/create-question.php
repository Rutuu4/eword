...
{  
  ...
  $qry_chk="SELECT MAX(id) AS max_id  FROM question_list";    
  $result_chk=$conn->query($qry_chk);
  $row_chk=$result_chk->fetch_array();
  $display_order=$row_chk['max_id']+1;

  $qury1="INSERT INTO question_list(title_name, video_link, details, status, user_id, create_datetime,display_order) VALUES ('$title_name','$video_link','$details','$status','$login_id','$create_datetime','$display_order')";          
