...
{  
  ...
  $qury1="Update website_list set name='$name', status='$status',website_link='$website_link',display_order='$display_order'  where id='$id'";          
  $sq1=$conn->query($qury1);

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-website.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM website_list WHERE id='$id'";  
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="website_link"  id="website_link" placeholder="Enter Website Link " value="<?=$row['website_link'];?>" required>
              </div>
            </div>
