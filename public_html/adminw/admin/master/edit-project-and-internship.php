    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Project and Internship</h1>
            </section>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="city_id" id="city_id" class="form-control" required>
                                        ...
                                        <?php
                                        $sqlb = "SELECT id,name FROM city_project where status=1 ORDER BY name ASC";
                                        $resultb = $conn->query($sqlb);
                                        while ($rowb = $resultb->fetch_array()) {
                                        ?>
                            ...
                            ?>
                            <div class="form-group">
                                <label for="class_type_id" class="col-sm-2">Project Type :</label>
                                <div class="col-sm-8">
                                    <select name="class_type_id[]" id="class_type_id" class="form-control select2"
                                        multiple required>
                                        <option value="Part_time"
                                            <?= in_array("Part_time", $selected_class_types) ? 'selected' : '' ?>>Part
                                            Time</option>
                                        <option value="Full_time"
                                            <?= in_array("Full_time", $selected_class_types) ? 'selected' : '' ?>>Full
                                            Time</option>
                                        <option value="Remote"
