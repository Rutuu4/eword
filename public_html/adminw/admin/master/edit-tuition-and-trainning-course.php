...
$qury1="UPDATE t_courses SET name='$name',status='$status' where id='$id'";

 $sq1 = $conn->query($qury1); 

  if(mysqli_affected_rows($conn)>=1){  header("location:../manage-tuition-and-trainning-course.php"); }
...
if(!empty($_GET['key'])){
  ...
  $qry="SELECT * FROM t_courses WHERE id='$id'";  
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Tuition and Trainning Details</h1>
            </section>
