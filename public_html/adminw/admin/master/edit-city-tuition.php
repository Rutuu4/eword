...
if ($_POST['h1'] == 1) {
    ...
    $qury1 = "UPDATE city_tuition SET name='$name',status='$status' where id='$id'";

    $sq1 = $conn->query($qury1);

    if (mysqli_affected_rows($conn) >= 1) {
        header("location:../manage-city-tuition.php");
    }
}
...
<body class="<?= $bodyclass ?>">
    ...
    if (!empty($_GET['key'])) {
        ...
        $qry = "SELECT * FROM city_tuition WHERE id='$id'";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Update Tuition Training City</h1>
            </section>
