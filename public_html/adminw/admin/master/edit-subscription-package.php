...
{  
  ...
  $qury1="Update subscription_package set name='$name',price='$price',details='$details',video_link='$video_link'  where id='$id'";          
        ...
        <div class="box-body">
          <form action="" method="POST" id="" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="video_link"  id="video_link" placeholder="Enter Name " value="<?=$row['video_link'];?>"  >
              </div>
            </div>
