        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            -->
              <div class="box-body">
                <h4>
                  Manage Register User Notification List (Last 100 Days)
                  <a href="master/create-register-user-notification.php" class="btn btn-primary pull-right">Create Notification</a>
                </h4>
                <?php
            ...
            <div class="box">
              <div class="box-body table-responsive">
                <table id="datatable" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $qry = "SELECT * FROM mobile_notification 
                  WHERE id > 0 and notification_type=3";
                    if (!empty($fromdate) and  !empty($todate)) {
                      $qry .= " && datee between '$fromdate' and  '$todate'";
                    }
                    if (empty($fromdate) or  empty($todate)) {
                      $qry .= " && datee >= DATE_SUB(CURDATE(),INTERVAL 100 DAY)";
                    }
                    $qry .= " group by id order by id desc";
