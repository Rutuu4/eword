          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT admission_process.*,m_main_courses.name AS main_courses_name,m_exrta_course.name AS courses_details_name FROM admission_process 
                  left join m_main_courses on m_main_courses.id=admission_process.main_courses_id
                  left join m_exrta_course on m_exrta_course.id=admission_process.courses_details_id
                  order by admission_process.id ASC";
...
<!-- <td><?=$row['display_order'];?></td>-->
  <td><?=$statuss;?></td>
                  ...
                  <a button class="btn btn-danger btn-sm" onClick="window.open('master/delete-admission.php?id=<?=$row['id'];?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i class="fa fa-trash"></i> Delete </button></a>
