        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            -->
                    <div class="box-body">
              <h4>
              Manage Coursewise Notification List (Last 100 Days)
            ...
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
               ...
               <tr>
                  ...
                  <td>
                   <a href="master/edit-coursewise-notification.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-eye"></i> </a>
