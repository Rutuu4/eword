        ...
        <div class="content-wrapper">
            ...
            -->
                            <div class="box-body">
                                <h4>
                                    Manage country List
                                    <a href="master/create-country.php"
                                        class="btn btn-primary pull-right">Create country </a>
                                </h4>
                            </div>
                        </div>
...
";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="master/edit-country.php?key=<?= base64_encode($row['id']) ?>"
                                                        class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>

                                                    <a button class="btn btn-danger btn-sm"
                                                        onClick="window.open('master/delete-country.php?id=<?= $row['id']; ?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i
