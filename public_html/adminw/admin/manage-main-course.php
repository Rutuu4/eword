      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
               Manage Main Course List
                  <a href="master/create-main-course.php" class="btn btn-primary pull-right" >Create Main Course List</a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM m_main_courses order by display_order ASC";
                ...
                <tr>
                  ...
                  <td>
                    <a href="master/edit-main-course.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
