  ...
  <?php
    if(empty($profile)){
      $profileimgg = "../dist/img/avatar5.png";
    }else{
      $profileimgg = $profile;
    }
  ?>
  <header class="main-header">
    <a href="" class="logo" style="padding: 0px;background-color: #b6ddfc">
      <span class="logo-mini"></span>
      <span class="logo-lg"><b style="color:#0e385c;">E World Education</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo ucfirst($show_name); ?></span>
            </a>
            <ul class="dropdown-menu dropdown-web">
              <li class="user-header">
                
                <img src="<?=$profileimgg?>" class="img-circle" alt="User Image">
                <p><?=ucfirst($show_name) ?> - <?=ucfirst($usertype) ?></p>
              </li>
              <!-- Menu Footer-->
