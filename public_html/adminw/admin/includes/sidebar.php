      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
         ...
         <li><a href="master/csv-college-university-course.php"><i class="fa fa-circle-o"></i>Add College University Course</a></li>
         <li><a href="master/csv-website.php"><i class="fa fa-circle-o"></i>Upload Website CSV</a></li>
         <li><a href="master/csv-update-course-video-link.php"><i class="fa fa-circle-o"></i>Update Course Video Link CSV</a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
       ...
       <li><a href="register-user-notification"><i class="fa fa-circle-o"></i> <span>Register User Notification</span></a> </li>
   ...
   <li class="treeview">
    ...
    <ul class="treeview-menu">
     <li><a href="admin-promocode.php"><i class="fa fa-circle-o"></i> <span>Promocode List</span></a> </li>
   </ul>
 </li>
