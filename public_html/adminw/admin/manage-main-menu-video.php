          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM main_manu_video_list where status=1 order by id ASC";
                ...
                <tr>
                  ...
                  <td>
                    <a href="master/edit-main-menu-video.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                  </td>
