              ...
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  while($row = $result->fetch_array()){
                    ...
                    $qry_inner="SELECT * from registration where id='$registration_id'";
...
<!--                   <td ><?=$row['email'];?></td>
 -->                  <td ><?=$row_inner['city'];?></td>
                    <td ><?=$row_inner['study_city'];?></td>
                      <td ><?=$row_inner['current_study'];?></td>
                      <td ><?=$row_inner['college_university_name'];?></td>
