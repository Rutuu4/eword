        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
               Manage Course List
                  <a href="master/create-course-details.php" class="btn btn-primary pull-right" >Create Course </a>
              </h4>
            </div>
          </div>
          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT courses_details.*,m_main_courses.name AS main_course_name,m_exrta_course.name AS extra_course_name FROM courses_details 
                  left join m_main_courses on m_main_courses.id=courses_details.main_courses_id
                  left join m_exrta_course on m_exrta_course.id=courses_details.extra_course_id
                  where courses_details.is_hide=0 
                  order by m_main_courses.display_order ASC,m_exrta_course.name ASC,
                                 CASE
                ...
                <tr>
                 ...
                 <!--   <td><?=$row['video_link'];?></td> -->
                  ...
                  <td>
                    <a href="master/edit-course-details.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>

                     <a button class="btn btn-danger btn-sm" onClick="window.open('master/delete-course.php?id=<?=$row['id'];?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i class="fa fa-trash"></i> Delete </button></a>
