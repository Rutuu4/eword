          ...
          <div class="box">
            <div class="box-body table-responsive">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <?php
                  $i = 0;
                  $qry = "SELECT * FROM registration where is_app_admin=1 order by id desc";
                ...
                <!--   <td ><?=$statuss;?></td> -->
                 ...
                 <!-- <td >
                    <a href="master/edit-application-admin-user.php?id=<?php echo $row['id'];?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                   
                  </td>-->
                  
                  <td><a href="master/edit-application-admin-user.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                  </td>
                </tr>
                <?php } ?>
              </table>
