      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <h4>
              Active Subscription List (Last 1 Year)
              </h4>
              <?php
              ...
              <div class="form-group">
               ...
               <form action="active-subscription-csv.php" method="post">
               <div class="col-sm-2 col-md-2 col-xs-12" style="padding-top:26px;">

                    <input type="hidden" name="fromdate" value="<?=$fromdate;?>">
                    <input type="hidden" name="todate" value="<?=$todate;?>">
                   
                   <button type="submit" name="submitexport" value="submitexport" class="btn btn-primary">Export-Excel</button>
                 </div>
              </form>
            </div>
          </div>
          ...
          <div class="box">
            ...
            where package_subscription_order.payment_gateway_success_status=1 and package_subscription_order.txnid!='' and package_subscription_order.subscription_expire_date>'$date'";
          if(!empty($fromdate) AND  !empty($todate)){  $qry .= " && package_subscription_order.date between '$fromdate' and  '$todate'"; }
           ...
           $result=$conn->query($qry);
                ...
                <!--  <td><a href="master/edit-register-user.php?id=<?php echo $row['id'];?>" class="btn btn-warning"><i class="fa fa-eye"></i></a></td>-->
                   <td><a href="master/edit-register-user.php?key=<?=base64_encode($row['id'])?>" class="btn btn-warning"><i class="fa fa-eye"></i></a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
