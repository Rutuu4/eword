    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            -->
                            <div class="box-body">
                                <h4>
                                    Manage Openning List
                                    <a href="master/create-job-and-placement-openning.php"
                                        class="btn btn-primary pull-right">Create Openning </a>
                                </h4>
                            </div>
                        </div>
                            ...
                            <div class="box-body table-responsive">
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                  $i = 0;
                  $qry = "SELECT * FROM j_openings  
ORDER BY 
  CASE 
    WHEN position_name REGEXP '^[઀-૿]' THEN 0 
    ELSE 1 
  END, 
  position_name ASC;
";
                ...
                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="master/edit-job-and-placement-openning.php?key=<?=base64_encode($row['id'])?>"
                                                    class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>

                                                <a button class="btn btn-danger btn-sm"
                                                    onClick="window.open('master/delete-job-and-placement-openning.php?id=<?=$row['id'];?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i
