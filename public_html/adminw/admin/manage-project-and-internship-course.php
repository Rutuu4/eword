    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            -->
                            <div class="box-body">
                                <h4>
                                    Manage Project and Internship Course List
                                    <a href="master/create-project-and-internship-course.php"
                                        class="btn btn-primary pull-right">Create Project and Internship Course </a>
                                </h4>
                            </div>
                        </div>
                            ...
                            <div class="box-body table-responsive">
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                  $i = 0;
                  $qry = "SELECT * FROM p_courses  
ORDER BY 
  CASE 
    WHEN name REGEXP '^[઀-૿]' THEN 0 
    ELSE 1 
  END, 
  name ASC;
";
                ...
                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="master/edit-project-and-internship-course.php?key=<?=base64_encode($row['id'])?>"
                                                    class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>

                                                <a button class="btn btn-danger btn-sm"
                                                    onClick="window.open('master/delete-project-and-internship-course.php?id=<?=$row['id'];?>',   'win1','width=950, height=800, menubar=no ,scrollbars=yes,top=50,left=100')"><i
