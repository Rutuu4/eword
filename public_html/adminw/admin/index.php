...
$qry_sub_courses="SELECT id FROM m_exrta_course where status=1"; 
$result_sub_courses = $conn->query($qry_sub_courses);
$total_sub_courses=mysqli_num_rows($result_sub_courses);



$qry_courses="SELECT id FROM courses_details where status=1 and is_hide=0"; 
...
$promocode="SELECT id FROM promocode"; 
$result_product = $conn->query($promocode);
$totalProcodeCount=mysqli_num_rows($result_product);
        ...
        <div class="row">
            ...
            <div class="info-box bg-orange">
              ...
              <div class="info-box-content">
                ...
                <span class="progress-description">
                  <a style="color: white;" href="admin-user.php">Click For More</a>
                </span>
              </div>
            </div>
          </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box bg-orange">
            <span class="info-box-icon"><i class="fa fa-book"></i></span>
            <div class="info-box-content">
              <span class="info-box-text">Total Sub Course</span>
              <span class="info-box-number"><?=$total_sub_courses?></span>
              <div class="progress">
                <div class="progress-bar" style="width: 70%"></div>
              </div>
              <span class="progress-description">
                <a style="color: white;" href="manage-sub-course.php">Click For More</a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box bg-orange">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$totalProcodeCount?></span>
              <div class="progress">
                <div class="progress-bar" style="width: 70%"></div>
              </div>
              <span class="progress-description">
                <a style="color: white;" href="admin-promocode.php">Click For More</a>
              </span>
            </div>
          </div>
        </div>
